                                       ...
                                       Vec3D*** coords, Vec5D*** v, double*** id, vector<double***> phi)
{
  ...
  std::string filename = "IC/solution_0010.vtr"; //Relative path from the place simulation is run.
  ...
  int INACTIVE_ID = 2; //!< problem-specific, usually equal to the number of active materials.
